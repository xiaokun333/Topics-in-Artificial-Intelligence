...
def main():
    ...
    for j in range(epoch):
        ...
        print("1024: " + str(len(np.where(maxTile == 1024)[0]) / 10))
        print("2048: " + str(len(np.where(maxTile == 2048)[0]) / 10))
        print("4096: " + str(len(np.where(maxTile == 4096)[0]) / 10))
        print("8192: " + str(len(np.where(maxTile == 8192)[0]) / 10))
        if len(np.where(maxTile >= 2048)[0]) >= 3 and len(np.where(maxTile >= 1024)[0]) >= 5:
            fullcredit[j] = 1
        print("Current chance to get full credit: " + str(np.sum(fullcredit) / (j + 1)))

    print(np.sum(fullcredit) / epoch)
    all_list = np.asarray(all_list)
    print("1024: " + str(len(np.where(all_list == 1024)[0]) / 10 / epoch))
    print("2048: " + str(len(np.where(all_list == 2048)[0]) / 10 / epoch))
    print("4096: " + str(len(np.where(all_list == 4096)[0]) / 10 / epoch))
    print("8192: " + str(len(np.where(all_list == 8192)[0]) / 10 / epoch))
